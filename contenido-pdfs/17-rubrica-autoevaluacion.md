# Rúbrica de Autoevaluación de Debate
## Instrumento de Reflexión y Auto-crítica C1
...
- **Metacognición**: Desarrolla conciencia sobre tu propio aprendizaje
- **Identificación de áreas de mejora**: Detecta debilidades específicas
- **Seguimiento de progreso**: Mide tu evolución a lo largo del curso
- **Autocrítica constructiva**: Aprende de tus propios errores
- **Independencia**: Desarrolla capacidad de auto-corrección

### Cómo usar esta rúbrica
1. **Inmediatamente después del debate**: Reflexiona mientras está fresco
2. **Si es posible, revisa la grabación**: Objetividad adicional
3. **Sé honesto/a**: No seas ni demasiado crítico ni demasiado indulgente
4. **Específico/a**: Identifica ejemplos concretos
5. **Constructivo/a**: Enfócate en mejora, no solo en crítica

---

## PARTE 1: REFLEXIÓN INMEDIATA

### Preguntas de reflexión post-debate
...
**5. ¿Hubo algo inesperado que ocurriera? ¿Cómo lo manejaste?**
- _________________________

---

## PARTE 2: AUTOEVALUACIÓN DETALLADA

### Sección 2.1: Preparación
...
**Puntuación total preparación: _____ / 16**

**Reflexión sobre preparación:**
- ¿Qué funcionó bien en tu preparación?
  _________________________
...
| **Variedad de tipos de argumentos** | | | |
...
**Puntuación total argumentación: _____ / 16**

**Reflexión sobre argumentación:**
- ¿Qué argumento tuyo fue más efectivo? ¿Por qué?
  _________________________
- ¿Qué argumento podría haber mejorado? ¿Cómo?
  _________________________

---

### Sección 2.3: Expresión Oral
...
**Puntuación total expresión: _____ / 16**

**Reflexión sobre expresión:**
- ¿En qué aspecto lingüístico te sentiste más segura/o?
  _________________________
- ¿Qué aspecto lingüístico necesita más trabajo?
  _________________________

---

### Sección 2.4: Organización

| Aspecto | Puntuación (1-4) | Evidencia/Ejemplo | Área de mejora |
|---------|------------------|-------------------|----------------|
| **Estructura (apertura, desarrollo, refutación, cierre)** | | | |
...
**Puntuación total organización: _____ / 16**

**Reflexión sobre organización:**
- ¿Qué aspecto organizacional funcionó mejor?
  _________________________
- ¿Cómo mejorarías tu organización la próxima vez?
  _________________________

---

### Sección 2.5: Estrategias Comunicativas
...
**Puntuación total estrategias: _____ / 16**

**Reflexión sobre estrategias:**
- ¿Qué estrategia comunicativa usaste mejor?
  _________________________
- ¿Qué estrategia comunicativa necesita más desarrollo?
  _________________________

---

## PARTE 3: ANÁLISIS DE FORTALEZAS Y DEBILIDADES
...
### Áreas de mejora principales (Top 3)

**1. ** _________________________
   - Plan de acción: _________________________
...
## PARTE 4: COMPARACIÓN CON DEBATES ANTERIORES

### Si has hecho debates anteriores, compara:
...
- ¿En qué áreas has mejorado más?
  _________________________
- ¿Qué áreas siguen necesitando trabajo?
  _________________________

---

## PARTE 5: OBJETIVOS PARA EL PRÓXIMO DEBATE

### Específicos, medibles, alcanzables, relevantes, temporales (SMART)

**Objetivo 1:**
- **Qué mejorarás:** _________________________
- **Cómo lo harás:** _________________________
- **Cómo medirás el éxito:** _________________________
...
**¿Qué aprendiste sobre TI MISMA/O como comunicadora/or durante este debate?**

Respuesta: _________________________

**¿Qué harías diferente si pudieras repetir este debate?**

Respuesta: _________________________

**¿Qué consejo le darías a un/a estudiante que va a hacer su primer debate?**

Respuesta: _________________________

---

## PUNTUACIÓN TOTAL DE AUTOEVALUACIÓN

**Preparación:** _____ / 16
**Argumentación:** _____ / 16
**Expresión Oral:** _____ / 16
**Organización:** _____ / 16
**Estrategias Comunicativas:** _____ / 16

**TOTAL: _____ / 80**

### Conversión a auto-nota

- **72-80** (90-100%): **Autoevaluación Excelente**
- **56-71** (70-89%): **Autoevaluación Buena**
- **40-55** (50-69%): **Autoevaluación Suficiente**
- **0-39** (0-49%): **Autoevaluación Insuficiente**

**Tu auto-nota: _____**

---

## COMPARACIÓN CON NOTA DEL PROFESOR

Después de recibir la nota del profesor/a:

**Nota profesor/a:** _____
**Tu auto-nota:** _____
**Diferencia:** +/- _____ puntos

**¿Por qué crees que hay diferencia?**
- _________________________

**¿Te evaluaste demasiado duramente o demasiado indulgentemente?**
- _________________________
...
**Fecha del debate:** _________________________
**Tema del debate:** _________________________
**Fecha de autoevaluación:** _________________________

---

**Sesión 8: Autoevaluación de Debate**
